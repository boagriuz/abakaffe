...
def main():
    try:
        ...
        if dev is None:
            ...
            print "\nWeight was found, going live!\n"
#           devmanufacturer = usb.util.get_string(dev, 256, dev.iManufacturer)
#           devname = usb.util.get_string(dev, 256, dev.iSerialNumber)
#           print "device found: " + devmanufacturer + " " + devname

            interface = 0
            if dev.is_kernel_driver_active(interface) is True:
                print "\nbut We need to detach kernel driver"
