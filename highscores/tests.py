...
class BrewerTestCase(TestCase):
    ...
    def setUp(self):
        ...
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1111'),
                             dateTime=datetime.datetime(2016, 4, 24, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1111'),
                             dateTime=datetime.datetime(2016, 4, 22, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1112'),
                             dateTime=datetime.datetime(2016, 4, 13, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1112'),
                             dateTime=datetime.datetime(2016, 4, 21, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1113'),
                             dateTime=datetime.datetime(2016, 4, 17, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1114'),
                             dateTime=datetime.datetime(2015, 4, 24, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1114'),
                             dateTime=datetime.datetime(2015, 4, 22, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1114'),
                             dateTime=datetime.datetime(2015, 4, 13, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1114'),
                             dateTime=datetime.datetime(2015, 4, 21, 19, 45, 30, 4))
        Brews.objects.create(RFID=CoffeeBrewer.objects.get(RFID='1114'),
                             dateTime=datetime.datetime(2015, 4, 17, 19, 45, 30, 4))
